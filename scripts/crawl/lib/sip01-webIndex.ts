/**
 * VENDORED from sip-01-core/src/protocol/webIndex.ts (SIP-01 v1.2 reference
 * implementation, github.com/NostrDanish/SIP-01).
 *
 * DO NOT MODIFY — byte-compatibility with SIP-01 §13 is mandatory: every
 * indexer in the ecosystem must derive identical d/u/x values for the same
 * page, or cross-indexer deduplication breaks. Upgrade by re-copying the
 * upstream file, never by editing this one.
 */
/**
