...
export const SEED_SOURCES: SeedSource[] = [
  ...
  {
    id: 'github-bounties',
    name: 'GitHub bounty issues',
    homepage: 'https://github.com/search?q=label%3Abounty+state%3Aopen&type=issues',
    description:
      'Open GitHub issues carrying the "bounty" label across all public repositories, via the Search API. Funder attribution is per-repository (owner/name).',
    adapter: 'github-search-api',
    endpoints: [{ url: 'https://api.github.com/search/issues', kind: 'api' }],
    schedule: '0 4 * * *',
    status: 'healthy',
    topics: ['open source', 'bounty', 'software'],
    countries: ['GLOBAL'],
  },
  {
    id: 'manifund',
    name: 'Manifund',
    homepage: 'https://manifund.org/',
    description:
      'Regranting and impact-certificate marketplace for AI safety and effective altruism projects. Public JSON API lists projects currently seeking funding.',
    adapter: 'manifund-api',
    endpoints: [{ url: 'https://manifund.org/api/v0/projects', kind: 'api' }],
    schedule: '15 */6 * * *',
    status: 'healthy',
    topics: ['ai safety', 'effective altruism', 'research'],
    countries: ['GLOBAL'],
    funder: { name: 'Manifund', id: 'manifund' },
  },
  {
    id: 'nih-reporter',
    name: 'NIH RePORTER (awards)',
    homepage: 'https://reporter.nih.gov/',
    description:
      'The NIH RePORTER API exposes every NIH-funded project with amounts, recipient organisations and abstracts — the historical awards half of the graph.',
    adapter: 'nih-reporter-api',
    endpoints: [{ url: 'https://api.reporter.nih.gov/v2/projects/search', kind: 'api' }],
    schedule: '30 2 * * *',
